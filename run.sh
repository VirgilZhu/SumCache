python needle_eval.py --model NousResearch/Meta-Llama-3.1-8B-Instruct --modified sumcache --topk 192 --ctx_len 6000 --num_sum_tokens 4 --topk_important 4 --chunk_size 64 --sum_compress_ratio 0.5
