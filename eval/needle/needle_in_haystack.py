...
from my_utils.my_generation import set_topk, my_greedy_generate_standard, my_greedy_generate_selection
...
class LLMNeedleHaystackTester:
    ...
    def __init__(self,
        ...
        if(model_name_suffix is not None): self.model_version += "-" + model_name_suffix
        ...
        if(self.model_provider in ["OpenAI", "Anthropic"]):
            ...
            with torch.no_grad():
                ...
                if self.modified == 'gemfilter':
                    ...
                    response = my_greedy_generate_standard(input_ids, attn_mask, self.model_to_test, self.enc, max_gen_len=50)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--modified', type=str, default=None, help='whether modified')
